...
"""
BUSTER entity definitions with no examples
"""
...
class GenericConsultingCompany(Entity):
    ...
    Avoid labeling a company that primarily provides legal services. Exercise caution with company names that include personal names which might be confused with individuals, and consider the context to determine whether the reference is to a company.
    """
